...
In this scenario, we are going to initialize and unseal OpenBao for the first time.
...
More information on the [seal unseal mechanism and concept is in the docs](https://openbao.org/docs/concepts/seal/#auto-unseal).
